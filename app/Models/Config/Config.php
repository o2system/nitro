 ...
 *
 * Enables protection against Clickjacking attack.
 * When set to TRUE, will only allowed from i-framing from same domain only.
 *
 * @var bool
 */
$config[ 'security' ][ 'protection' ][ 'clickjacking' ] = false;
