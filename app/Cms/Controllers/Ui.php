...
use Cms\Http\AccessControl\Controllers\AuthenticatedController;
 ...
 */
class Ui extends AuthenticatedController
{
    /**
     * Dashboard::index
     */
    public function index()
    {
        ...
        $cards[ 'basic' ]->createImage( PATH_STORAGE . 'images/ui/white-stone-harbor.jpg', 'White Stone Harbor' );
        ...
        $image = $cards[ 'with-overlay' ]->createImage( PATH_STORAGE . 'images/ui/karimun-java-monument.jpg',
        ...
        $cards[ 'with-list-group' ]->createImage( PATH_STORAGE . 'images/ui/stone-mask-hut.jpg', 'Stone Mask Hut' );
        ...
        foreach ( range( 1, 3 ) as $number ) {
            ...
            $card->createImage( PATH_STORAGE . 'images/ui/landscape' . $number . '.jpg', 'Card image ' . $number );
        ...
        $card->createImage( PATH_STORAGE . 'images/ui/landscape1.jpg', 'Card custom with badges' );
        ...
        // Card with badge
        $card = $cards[ 'customs' ]->createCard();
        $card->createImage( PATH_STORAGE . 'images/ui/landscape2.jpg', 'Card custom with ribbons' );
        ...
        foreach ( range( 1, 3 ) as $number ) {
            ...
            $slide->createImage( PATH_STORAGE . 'images/ui/landscape' . $number . '.jpg',
        ...
        $jumbotron[ 'image' ]->setImageBackground( PATH_STORAGE . 'images/ui/bg-galaxy.jpg' );
        ...
        $jumbotron[ 'video' ]->setVideoBackground( PATH_STORAGE . 'media/explore.webm' );
...
Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.' )
        ...
        $image->setSrc( PATH_STORAGE . 'images/ui/zha-avatar.jpg' );
        $image->setWidth( 200 );
